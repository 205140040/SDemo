...
public class CookieServlet extends HttpServlet {
	...
	protected void service(HttpServletRequest request, HttpServletResponse response)
		 ...
		 */
		// 创建cookie
		Cookie cookie = new Cookie("uname", URLEncoder.encode("酱紫啊"));
		// 注释
		cookie.setComment(URLEncoder.encode("注释：userInfo"));
		// 使用域
		...
		out.println("cookieValue:" + URLDecoder.decode(cookie.getValue()) + "<br>");
		out.println("作用域名:" + cookie.getDomain() + "<br>");
		out.println("注释:" + URLDecoder.decode(cookie.getComment()) + "<br>");
